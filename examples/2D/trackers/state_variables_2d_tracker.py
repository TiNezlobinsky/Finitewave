...
"""
# State Variables in 2D

This example demonstrates how to use the Variable2DTracker and
MultiVariable2DTracker classes to track the values of the variables u and v at
