...
"""
This script runs a 2D simulation of cardiac tissue with 20% fibrosis using the TP06 model.
Fibrosis is simulated as mesh nodes with values = 2. 
You can generate it manulally or use one of the predefined patterns (like Diffuse2DPattern).
