...
"""
# Local Activation Time in 2D

This example demonstrates how to use the LocalActivationTime2DTracker to track
the local activation times of the spiral wave over time.
"""
