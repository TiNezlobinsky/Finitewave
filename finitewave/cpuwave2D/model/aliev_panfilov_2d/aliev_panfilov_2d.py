...
class AlievPanfilov2D(CardiacModel):
    ...
    Aliev-Panfilov equations. It extends the CardiacModel base class and
    provides methods to initialize the model, run the ionic kernel, and handle
    simulation state.
    ...
    def initialize(self):
        ...
        This method sets up the diffusion and ionic kernel functions,
        initializes arrays for the action potential and recovery variable,
        and prepares the model for simulation. It calls the base class
        initialization method and sets up the diffusion and ionic kernels
        specific to the Aliev-Panfilov model.
        """
        super().initialize()
        ...
        self.ionic_kernel = aliev_panfilov_ionic_kernel_2d
    ...
    def run_ionic_kernel(self):
        ...
        This method updates the action potential and recovery variable arrays
        using the ionic kernel function retrieved during initialization.

        It applies the Aliev-Panfilov equations to compute the next state of
        the action potential and recovery variable based on the current state
        of the model.
        """
